...
public class DepartmentItemStock extends GenericForwardComposer{
	...
	private String getSqlItemStock() {
		...
		+	"				(CASE WHEN itemstock.IsDispatch = 1 THEN 'แผนกเบิกใช้' WHEN itemstock.IsStatus = (-5) THEN 'จองส่งล้าง' ELSE 'รับเข้าแผนก' END) AS S_Status, "
		+	"				itemstock.UsageCode, "
		+	"				itemstock.IsPay, "
		...
		+	"	ORDER BY 	itemstock.IsStatus, itemstock.IsDispatch, itemstock.ExpireDate ASC, itemstock.UsageCode "
